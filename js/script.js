    ...
    works: [
        {
            ...
            coord: [118.8, 32.05],
            excerpt: '早期革命题材小说',
            nanjingDescription: '"以南京为背景的革命叙事，展现了近代知识分子的觉醒与抗争。"'
        }
    ]
};
    ...
    works: [
        {
            ...
            location: '南京',
            coord: [118.8, 32.05],
            excerpt: '新文学史上重要的白话小说',
            nanjingDescription: '"作为中国第一位白话文女作家，她的作品为南京的现代文学开辟了道路。"'
        },
        {
            id: 3,
            title: '一日',
            location: '南京',
            coord: [118.8, 32.05],
            excerpt: '比《狂人日记》发表更早的白话文小说',
            nanjingDescription: '"记录了一位女学生在南京的一天生活，是早期白话文实验的重要作品。"'
        }
    ]
};
    ...
    works: [
        {
            ...
            coord: [118.796, 32.078],
            excerpt: '自叙传小说',
            nanjingDescription: '"以南京玄武湖的秋景为背景，抒发了作者的个人情感与生活体验。"'
        }
    ]
};
...
authorsData['胡适'] = {
    ...
    intro: '思想家、文学家',
    works: [
        { id: 5, title: '我们三个朋友', location: '南京', coord: [118.8, 32.05] },
        { id: 6, title: '许怡孙', location: '南京', coord: [118.8, 32.05] },
        { id: 7, title: '湖上', location: '南京', coord: [118.8, 32.05] },
        { id: 8, title: '外交', location: '南京', coord: [118.8, 32.05] }
    ]
};
...
authorsData['陆志韦'] = {
    ...
    intro: '语言学家、诗人',
    works: [
        { id: 9, title: '渡河', location: '南京', coord: [118.8, 32.05] }
    ]
};

// 添加卢前（补充）
if (authorsData['卢前']) {
    authorsData['卢前'].works.push(
        { id: 10, title: '春雨', location: '南京', coord: [118.8, 32.05] },
        { id: 11, title: '绿帘', location: '南京', coord: [118.8, 32.05] },
        { id: 12, title: '民族诗歌论集', location: '南京', coord: [118.8, 32.05] }
    );
}
...
authorsData['丘逢甲'] = {
    ...
    intro: '诗人',
    works: [
        { id: 13, title: '谒明孝陵', location: '明孝陵', coord: [118.854, 32.065] },
        { id: 14, title: '登扫叶楼', location: '扫叶楼', coord: [118.774, 32.070] },
        { id: 15, title: '雪中游莫愁湖', location: '莫愁湖', coord: [118.776, 32.026] }
    ]
};
...
authorsData['周岸登'] = {
    ...
    intro: '词人',
    works: [
        { id: 16, title: '台城路·重过金陵', location: '南京', coord: [118.8, 32.05] }
    ]
};
...
authorsData['徐震堮'] = {
    ...
    intro: '学者、诗人',
    works: [
        { id: 17, title: '忆旧游·台城秋柳', location: '台城', coord: [118.792, 32.068] }
    ]
};
...
authorsData['柳诒徵'] = {
    ...
    intro: '历史学家、诗人',
    works: [
        { id: 18, title: '独往灵谷寺', location: '灵谷寺', coord: [118.868, 32.070] },
        { id: 19, title: '庚申四月十日游牛首山', location: '牛首山', coord: [118.818, 31.954] }
    ]
};
...
authorsData['向楚'] = {
    ...
    intro: '诗人',
    works: [
        { id: 20, title: '过金陵', location: '南京', coord: [118.8, 32.05] }
    ]
};
...
authorsData['陈衡恪'] = {
    ...
    intro: '画家、诗人',
    works: [
        { id: 21, title: '浦口待车·是时闻临城盗劫', location: '浦口', coord: [118.740, 32.150] }
    ]
};
...
authorsData['吴芳吉'] = {
    ...
    intro: '诗人',
    works: [
        { id: 22, title: '寄答陈鼎芬君南京慰其升学之失意也', location: '南京', coord: [118.8, 32.05] }
    ]
};
...
authorsData['陈三立'] = {
    ...
    intro: '诗人',
    works: [
        { id: 23, title: '散原精舍诗', location: '南京', coord: [118.8, 32.05] },
        { id: 24, title: '散原精舍诗续集', location: '南京', coord: [118.8, 32.05] }
    ]
};
...
authorsData['陈瘦竹'] = {
    ...
    intro: '作家',
    works: [
        { id: 25, title: '奈何天', location: '南京', coord: [118.8, 32.05] },
        { id: 26, title: '灿烂的火花', location: '南京', coord: [118.8, 32.05] }
    ]
};
...
authorsData['叶灵凤'] = {
    ...
    intro: '作家',
    works: [
        { id: 27, title: '内疚', location: '南京', coord: [118.8, 32.05] },
        { id: 28, title: '摩伽的试探', location: '南京', coord: [118.8, 32.05] },
        // ... 其他作品可继续添加
    ]
};
...
authorsData['丁玲'] = {
    ...
    intro: '作家',
    works: [
        { id: 29, title: '意外集', location: '南京', coord: [118.8, 32.05] }
    ]
};
...
authorsData['沈祖棻'] = {
    ...
    intro: '词人、学者',
    works: [
        { id: 30, title: '辩才禅师', location: '南京', coord: [118.8, 32.05] },
        { id: 31, title: '茂陵的雨夜', location: '南京', coord: [118.8, 32.05] },
        // ... 其他作品
    ]
};
...
authorsData['赛珍珠'] = {
    ...
    intro: '美国作家',
    works: [
        { id: 32, title: '大地', location: '南京', coord: [118.8, 32.05] },
        { id: 33, title: '也在中国', location: '南京', coord: [118.8, 32.05] },
        // ... 其他作品
    ]
};
    ...
    works: [
        {
            ...
            location: '南京',
            coord: [118.8, 32.05],
            excerpt: '描写南京大屠杀的文学作品',
            nanjingDescription: '"以血祭为主题，控诉了侵华日军在南京的暴行，是重要的抗战文学作品。"'
        }
    ]
};
...
authorsData['张天翼'] = {
    ...
    intro: '作家',
    works: [
        { id: 35, title: '华威先生', location: '南京', coord: [118.8, 32.05] },
        { id: 36, title: '谭九先生的工作', location: '南京', coord: [118.8, 32.05] }
    ]
};
...
authorsData['张恨水'] = {
    ...
    intro: '通俗小说家',
    works: [
        { id: 37, title: '八十一梦', location: '南京', coord: [118.8, 32.05] },
        { id: 38, title: '石头城外', location: '南京', coord: [118.8, 32.05] },
        // ... 其他作品
    ]
};
...
authorsData['张爱玲'] = {
    ...
    intro: '作家',
    works: [
        { id: 39, title: '半生缘', location: '南京', coord: [118.8, 32.05] },
        { id: 40, title: '小团圆', location: '南京', coord: [118.8, 32.05] }
    ]
};
...
authorsData['无名氏'] = {
    ...
    intro: '作家',
    works: [
        { id: 41, title: '塔里的女人', location: '南京', coord: [118.8, 32.05] },
        { id: 42, title: '北极风情画', location: '南京', coord: [118.8, 32.05] }
    ]
};
